...
with open(r'lista_compras.csv', 'a', newline='') as csvfile:        #
    fieldnames = ['produto','valor','quantidade','total']           #       criando uma planilha csv desta lista
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)         #
    writer.writerow({'produto':'produto', 'valor':'valor',
...
def prod():
    ...
    def calc_item():
        ...
        calculo = round(quantidade2 * valor2, 2)                      ### EXECUTA CALCULO DE DUAS VARIAVEIS ###
        ...
        with open(r'lista_compras.csv', 'a', newline='') as csvfile:        #
            fieldnames = ['produto','valor','quantidade','total']           #
            writer = csv.DictWriter(csvfile, fieldnames=fieldnames)         #      salvando dados em uma planilha csv
            writer.writerow({'produto':produto2, 'valor':valor2,
                             'quantidade':quantidade2,'total':calculo})     #
